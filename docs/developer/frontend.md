...
###### _\*Note: This is technically a lie. In actuality, **index.js**, reads **index.scss** as well as the React files, making it the only entryway for all files bundled in the `src/` directory._
